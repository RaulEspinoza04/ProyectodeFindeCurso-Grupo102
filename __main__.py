...
if __name__ == '__main__':
    ...
    Estudiante1 = Estudiante(NombresE="Lorenzo Carlos", ApellidoPaternoE="Quiñonez",
                       ApellidoMaternoE="Quispe", ContrasenaE="753456")
    Estudiante2 = Estudiante(NombresE="Samuel de Luque", ApellidoPaternoE="Manzanarez",
                             ApellidoMaternoE="Dominguez", ContrasenaE="7896456")
